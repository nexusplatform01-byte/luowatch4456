...
export const contentPlans: SubscriptionPlan[] = [
  { id: "1day", name: "1 Day", duration: 1, price: 2000, priceFormatted: "UGX 2,000", description: "24 hours access — 6 downloads", type: "content", downloadLimit: 6 },
  { id: "1week", name: "1 Week", duration: 7, price: 8000, priceFormatted: "UGX 8,000", description: "7 days access — 20 downloads", type: "content", downloadLimit: 20 },
  { id: "1month", name: "1 Month", duration: 30, price: 30000, priceFormatted: "UGX 30,000", description: "30 days access — 80 downloads", type: "content", downloadLimit: 80 },
